...
export type RouteOption=Readonly<{id:string;from:string;to:string;originCountry:string;destinationCountry:string;international:boolean;stops:number;connections:string[];airlines:string[];flightMinutes:number;layoverMinutes:number;durationMinutes:number;routePath:string;price:PriceEstimate}>;

    ...
    <footer aria-label="Footer navigation" className="editorial-site-footer">
      <div className="editorial-site-footer__grid">
        ...
        >
          ...
          <p>
            Monthly data insights and route expansions direct to your inbox.
          </p>
          ...
          <div>
            ...
            />
            <button
              aria-label="Newsletter preview unavailable"
              disabled
              type="button"
            >
              →
          ...
          <small>Preview only — subscriptions are not enabled.</small>
        </section>
      </div>
